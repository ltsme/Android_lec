...
#include <stdio.h>
#include <stdlib.h>
#include "com_example_nam_healthforyou_ImageUtils.h"

using namespace jnicommon;

#define IMAGEUTILS_METHOD(METHOD_NAME) \
  Java_com_example_nam_healthforyou_ImageUtils_##METHOD_NAME  // NOLINT
...
JNIEXPORT void JNICALL IMAGEUTILS_METHOD(convertYUV420SPToRGB565)
        (JNIEnv* env, jclass clazz,jbyteArray input,jbyteArray output, jint width,jint height);
