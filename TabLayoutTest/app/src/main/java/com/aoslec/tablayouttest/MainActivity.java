...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabLayout.addTab(tabLayout.newTab().setText("Tab2 Item <<<<").setIcon(android.R.drawable.ic_dialog_alert));
        tabLayout.addTab(tabLayout.newTab().setText("Tab3 Item <<<<").setIcon(android.R.drawable.ic_dialog_dialer));
